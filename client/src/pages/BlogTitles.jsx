  ...
  const blogCategories = ['General',  'Technology', 'Business', 'Health', 'Lifestyle', 'Education', 'Travel', 'Food']
    ...
    const onSubmitHandler = async (e)=>{
      ...
      try {
         setLoading(true)
const prompt = `
Generate exactly 10 blog title ideas for the keyword "${input}" in the category "${selectedCategory}".
...
STRICT RULES:
1. Exactly 10 titles total.
2. Exactly 4 titles under Beginner-Friendly.
3. Exactly 4 titles under Intermediate/Advanced.
4. Exactly 2 titles under Creative and Catchy.
5. Use Markdown headings exactly as shown.
6. Use bullet points for every title.
7. Do not number the titles.
8. Do not explain anything.
9. Do not add an introduction.
10. Do not add a conclusion.
11. Do not add any text before or after the three sections.
`;
